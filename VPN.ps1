...
robocopy "${NAS_src}:\Filippo\dotfiles_backup\vpn_config" "$path" filippo.ovpn
robocopy "${NAS_src}:\Filippo\dotfiles_backup\vpn_config\openvpn_ufficio" "$path" VPNConfig.ovpn